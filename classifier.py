...
Если одно и то же мероприятие проходит в несколько разных дат, каждая дата — отдельное событие и отдельный объект.
Не объединяй несколько дат или всё расписание в одно событие.
